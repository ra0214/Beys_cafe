...
import { listaSecondOptionMenu, listaSecondOptionMenu1 } from "../../data/Background";

function ListaImagenesSecondOptionMenu() {
  return (
    <div className='felx flex-col items-center w-full mb-8'>
      <div className="grid grid-cols-3 justify-items-center w-full">
        {listaSecondOptionMenu.map((item, index) => (
        ...
        {listaSecondOptionMenu1.map((item, index) => (
          <a key={index} href={item.link} className='w-full flex justify-center'>
...
export default ListaImagenesSecondOptionMenu;
