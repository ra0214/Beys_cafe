...
import { listaThirdOptionMenu, listaThirdOptionMenu1 } from "../../data/Background";

function ListaImagenesThirdOptionMenu() {
  return (
    <div className='felx flex-col items-center w-full mb-8'>
      <div className="grid grid-cols-3 justify-items-center w-full">
        {listaThirdOptionMenu.map((item, index) => (
        ...
        {listaThirdOptionMenu1.map((item, index) => (
          <a key={index} href={item.link} className='w-full flex justify-center'>
...
export default ListaImagenesThirdOptionMenu;
