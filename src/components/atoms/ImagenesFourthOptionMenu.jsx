...
import { pilaFourthOptionMenu, pilaFourthOptionMenu1 } from "../../data/Background";

function ImagenesFourthOptionMenu() {
  return (
    <div className="flex flex-col items-center w-full">
      <div className="grid grid-cols-3 justify-items-center w-full">
        {pilaFourthOptionMenu.map((item, index) => (
      ...
      <div className="grid grid-cols-2 justify-items-center w-[80%] gap-4">
        {pilaFourthOptionMenu1.map((item, index) => (
          <a key={index} href={item.link} className='w-full flex justify-center'>
...
export default ImagenesFourthOptionMenu;